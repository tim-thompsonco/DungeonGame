...
namespace DungeonGameTests.Items.Consumables.Potions
{
	class HealthPotionUnitTests
	{
		...
		public void Setup()
		{
			potion = new HealthPotion(Potion.PotionStrength.Minor);
		...
		{
			potion = new HealthPotion(Potion.PotionStrength.Normal);
		...
		{
			potion = new HealthPotion(Potion.PotionStrength.Greater);
		...
		{
			potion = new HealthPotion(Potion.PotionStrength.Greater);  // Greater health potion restores 150 health
